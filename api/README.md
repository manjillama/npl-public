...
**Easier Nepal API server** is currently created using Node.js on the top of Express framework and TypeScript. For database, we've decided to go with MongoDB and and Mongoose as an ODM.
...
```bash
$ git clone https://github.com/manjillama/npl-public.git
